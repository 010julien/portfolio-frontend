...
const FloatingTranslateButton = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-8 right-8 z-50 bg-gradient-to-r from-blue-400 to-blue-400 hover:from-blue-700 hover:to-purple-700 text-white rounded-full p-4 shadow-2xl transition-all duration-300 hover:scale-110 group"
