  ...
  const managementSkills = [
    {
      ...
      description:
        "Coordination d'équipes pluridisciplinaires (développeurs, designers, ingénieurs logiciels)",
      color: "wax-blue",
      achievements: [
    ...
    },
    {
      ...
      description:
        "Mise en place de méthodologies agiles pour un développement itératif et efficace",
      color: "wax-green",
      achievements: [
    ...
    },
    {
      ...
      description:
        "Monitoring des objectifs, deadlines et livrables tout au long du cycle de vie du projet",
      color: "wax-orange",
      achievements: [
    ...
    },
    {
      ...
      title: "Communication",
      description:
        "Communication efficace avec les parties prenantes et maintien d'une bonne dynamique d'équipe",
      color: "wax-red",
      achievements: [
    ...
    },
    {
      ...
      description:
        "Capacité à aligner les objectifs techniques avec les enjeux business et stratégiques",
      color: "wax-purple",
      achievements: [
        "Analyse des besoins",
    ...
    },
    {
      ...
      description:
        "Identification rapide des blocages et mise en place de solutions adaptées",
      color: "wax-yellow",
      achievements: [
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Des compétences managériales pour piloter vos projets digitaux avec
            efficacité
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {managementSkills.map((skill, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-14 h-14 bg-${skill.color}/20 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                >
                ...
                <div className="space-y-2">
                  {skill.achievements.map((achievement, achIndex) => (
                    ...
                    >
                      <div
                        className={`w-1.5 h-1.5 bg-${skill.color} rounded-full`}
                      ></div>
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed italic">
            "Un bon manager ne se contente pas de diriger, il inspire, facilite
            et accompagne son équipe vers la réussite collective. La technologie
            est un moyen, mais ce sont les personnes qui font la différence.."
          </p>
        </motion.div>
      </div>
    </section>
